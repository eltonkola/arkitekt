...
public class MainScreen extends AppScreen<Void> {
    ...
    public void onEntered() {
        ...
        toolbar.setNavigationIcon(mContext.getResources().getDrawable(R.drawable.ic_dvr_white_24dp));
        ...
        mRootView.findViewById(R.id.butCreate).setOnClickListener(new View.OnClickListener() {
            @Override
